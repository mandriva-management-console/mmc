...
<script>
    new Ajax.PeriodicalUpdater('logupdater','<?= urlStrRedirect('base/logview/dnsshow') ?>','2',{evalScripts: true});
    new Ajax.Updater('container','<?= urlStrRedirect('base/logview/dnssetsearch') ?>');
</script>
