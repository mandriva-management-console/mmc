        ...
        */
        function updateSearch() {
            launch--;
                ...
                if (launch==0) {
                    new Ajax.Updater('container','modules/network/network/ajaxZoneMembersFilter.php?zone=<?=$zone?>&filter='+document.Form.param.value, { asynchronous:true, evalScripts: true});
                }
            }
