...
<input type="button" class="btnPrimary" value="<?= _T("Add a static host"); ?>" onclick="location.href='main.php?module=network&submod=network&action=subnetaddhost&subnet=<?= $subnet; ?>';"/>
