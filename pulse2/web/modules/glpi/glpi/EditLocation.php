...
// )
    ...
    if ($ID) {
    updateLocation($cfg['id'],$cfg['name'],$cfg['old_name'],$cfg['comment']);
    header('location: main.php?module=base&submod=computers&action=locationList' );
    }
};

$p = new PageGenerator(_T("Edit Location", "glpi"));
