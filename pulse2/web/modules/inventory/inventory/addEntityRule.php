...
// =================================
$selectOperatorType=new SelectItem("operator[]");
...
// =================================
$operator_select = new SelectItemtitle("operators[]",_T('match regular expression','inventory'));
...
// ================================= _T('equal to', 'glpi'),
$pattern_input = new InputTplTitle('patterns[]',
