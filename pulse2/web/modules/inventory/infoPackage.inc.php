...
if (!empty($submod)) {
    ...
    $tab = new Tab("grouptab6", _T("Summary tab for a group", "inventory"));
    $page->addTab($tab);

    $tab = new Tab("grouptab7", _T("Storage tab for a group", "inventory"));
    $page->addTab($tab);
    ...
    $tab = new Tab("tab6", _T("Summary tab for a computer in a group", "inventory"));
    $page->addTab($tab);

    $tab = new Tab("tab7", _T("Storage tab for a computer in a group", "inventory"));
    $page->addTab($tab);
